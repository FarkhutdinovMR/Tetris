...
public class CupView : MonoBehaviour
{
    ...
    public void BuildWalls(int width, int height)
    {
        ...
        {
            cells.Add(new Cell(new Vector2Int(i, -1), RandomColor));
            cells.Add(new Cell(new Vector2Int(i, heightOffset), RandomColor));
        }

        for (int i = 0; i < heightOffset; i++)
        {
            cells.Add(new Cell(new Vector2Int(-1, i), RandomColor));
            cells.Add(new Cell(new Vector2Int(width, i), RandomColor));
        }
